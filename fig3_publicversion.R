...
estGT$setting <- factor(estGT$setting, levels = c("Households", "Office work", "Restaurants", "Manual labour",
...
ggsave("Fig3_main_20241212.pdf", fig3, width = 12, height = 8.5, units = "in", dpi = 900)
